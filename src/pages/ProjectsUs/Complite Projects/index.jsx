  ...
  return (
    <div>
      ...
      <section className={style.sec2}>
        <h1>
          <u>Complete Projects</u>
        </h1>
        <div className={style.tablelist}>
          
            <ul className={style.unorder}>
              <li className={style.listboder}><a href="#">Commercial Projects</a> </li>
              <li className={style.listboder}><a href="#"> Multiplex Projects</a></li>
              <li className={style.listboder}><a href="#"> Residential Projects </a></li>
              <li className={style.listboder}><a href="#"> Hotel Projects</a></li>
              <li className={style.listboder}><a href="#"> Other Projects</a></li>
            </ul>
            ...
            <tbody>
              <tr className={style['row-white']}>
                ...
                <td className={style['tb-data']}>
                  <button className={style['btn-Img']}>View Image</button>
                </td>
              </tr>
